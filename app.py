...
/* 🔥 升級版：個股反查雷達專屬 Glassmorphism CSS */
.search-box-glass {
...
# 🌟 定義所有策略的邏輯說明文字 (全面改用三引號包覆，徹底根除語法跳脫問題)
logic_dict = {
