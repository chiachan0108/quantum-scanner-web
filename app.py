...
# [CSS 樣式極致壓縮版] 絕對保留未提及的設計與排版，並新增反查模組的專屬 UI
...
.search-box-container {
    background: linear-gradient(145deg, rgba(11, 15, 25, 0.9), rgba(22, 27, 34, 0.8));
...
.search-title {
    color: #ffffff; font-family: 'JetBrains Mono', monospace; font-size: 1.1rem;
    font-weight: 800; margin-bottom: 15px; display: flex; align-items: center; gap: 8px;
}
.strategy-badge {
    ...
    border-radius: 6px; color: #00f2ff; font-weight: 700; font-size: 0.85rem;
    box-shadow: 0 0 10px rgba(0, 242, 255, 0.1);
}
.search-result-name {
    color: #ffffff; font-size: 1.3rem; font-weight: 800; margin-bottom: 10px;
    border-bottom: 1px dashed rgba(255,255,255,0.2); padding-bottom: 10px;
}
