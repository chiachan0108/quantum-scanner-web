...
# 🌟 定義所有策略的邏輯說明文字 (新增策略 O 專屬卡片，並更新策略 R 說明為 14 取 4)
logic_dict = {
    ...
    # 🌟 策略 R 說明更新為 14 策略取 4 項以上 (納入 S 策略)
