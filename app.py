...
# 🌟 定義所有策略的邏輯說明文字 (新增策略 O 專屬卡片，並更新策略 R 說明為 4 項以上)
logic_dict = {
    ...
    if run_clicked:
        ...
        if is_t_valid:
            ...
            try:
                ...
                if strategy_choice in ["R. 複式策略交集型", "S. 趨勢轉折延伸型", "T. 自訂策略交集型"]:
