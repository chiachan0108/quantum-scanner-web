...
/* 🌟 策略選單專屬 CSS (利用 Grid 統一外框像素，強制換行絕對置中，徹底移除紅色原點) */
...
.stRadio div[role="radiogroup"] label {
    ...
    justify-content: center !important; /* 絕對居中 */
...
# 🌟 新增：安全防呆的 Markdown 文字產生器 (搭配 CSS 攔截器完美排版)
