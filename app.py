...
# =============================================================================
# [CSS 樣式核心] - 絕對置中、徹底消滅原生點點、完美發光、還原 Footer 與雷達質感
# =============================================================================
st.markdown("""<style>
...
[data-testid="stRadio"] > div[role="radiogroup"] {
    ...
    grid-template-columns: 1fr !important; /* 確保等寬 */
    gap: 12px !important; 
    width: 100% !important;
}

/* 🚨 終極核彈：徹底將點點「物理拔除」，不留任何佔位空間，解決左邊距過大問題 */
...
[data-testid="stRadio"] div[role="radiogroup"] label {
    ...
    padding: 16px !important; /* 確保四面八方 Padding 一致 */
    margin: 0 !important;
...
/* 🎯 處理 <p> 標籤預設 Margin 造成的「下方空白過大」問題 */
...
[data-testid="stRadio"] div[role="radiogroup"] label div[data-testid="stMarkdownContainer"] > p {
    margin: 0 !important; /* 徹底殺死預設的 1rem margin-bottom */
    padding: 0 !important;
    display: flex !important;
    flex-direction: column !important;
    align-items: center !important;
