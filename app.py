...
# [CSS 樣式極致壓縮版] 絕對保留未提及的設計與排版，並大幅升級反查模組的專屬 UI 質感
...
.search-target-id {
    ...
    color: #ffffff; text-shadow: 0 0 15px rgba(0, 242, 255, 0.3); line-height: 1; margin: 0;
}
.search-target-name {
    font-size: 1.2rem; font-weight: 700; color: #94a3b8; margin-left: 12px; letter-spacing: 1px;
}
.search-status-tag {
...
.search-subtitle {
    color: #94a3b8; font-size: 0.85rem; letter-spacing: 1px; margin-bottom: 5px; display: block;
}
        ...
        if search_query:
            ...
            if hit_strategies:
                ...
                <div class="search-box-glass">
                    ...
                    <span class="search-subtitle">🎯 標的當前觸發之量化策略矩陣：</span>
