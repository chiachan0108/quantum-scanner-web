...
.summary-box-group { 
  ...
  gap: 12px; 
  margin-bottom: 22px; 
  align-items: flex-start; /* 讓框靠左對齊網頁內容 */
...
.box-label { font-weight: 800; font-size: 0.9rem; color: #00f2ff; letter-spacing: 0.5px; line-height: 1; margin: 0; } 
.box-num { font-family: 'Inter', sans-serif; font-size: 1.15rem; color: #ffffff; font-weight: 700; line-height: 1; margin: 0; } 
.box-unit { font-weight: 800; font-size: 0.9rem; color: #00f2ff; line-height: 1; margin: 0; } 

/* 顏色覆寫獨立拉出，絕對繼承 */
.return-val-up { color: #ff3333 !important; } 
.return-val-down { color: #00ff33 !important; } 
.return-val-zero { color: #ffffff !important; }
...
if not st.session_state['scan_completed']:
    ...
    # 將上下兩個文字群組的 HTML 結構與 CSS 類別徹底統一
    avg_ret_html = f'''
