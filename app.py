...
.stRadio div[role="radiogroup"] label:has(input[type="radio"]:checked) {
    border: 1px solid #00f2ff !important; background-color: #0b0f19 !important;
...
.stRadio div[role="radiogroup"] label div[data-testid="stMarkdownContainer"] > p {
    ...
    line-height: 1.4 !important; display: block !important; width: 100% !important;
}
...
# 🌟 新增：最純淨、最安全的選項文字產生器 (不含 HTML，只用「｜」分隔)
